...
import { getUserCompanions, getUserSession } from "@/lib/actions/companion.action";
        ...
        <main className="min-lg:w-3/4">
            ...
            <Accordion type="multiple">
                ...
                <AccordionItem value="companions">
                    ...
                    <AccordionContent><CompanionsList title="My Companions" companions={companions}/> </AccordionContent>
                </AccordionItem>
            </Accordion>
        </main>
    );
